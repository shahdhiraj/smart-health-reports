...
import { Video, MessageSquare, Calendar, Clock, MoreVertical, CheckCircle } from 'lucide-react';
    ...
    return (
        <div className="w-full">
            <div className="mb-8">
                ...
                <p className="text-gray-500 mt-2">Manage your appointment schedule.</p>
            </div>
                ...
                {consultations.map((consult, index) => (
                    ...
                    >
                        ...
                        <div className="flex items-start gap-4 mb-6">
                            ...
                            />
                            <div>
                                <h3 className="text-lg font-bold text-gray-800">{consult.patient}</h3>
                                <p className="text-gray-500 text-sm">{consult.age} years old</p>
                        ...
                        <div className="flex items-center gap-3 pt-4 border-t border-gray-50">
                            <button className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl font-medium transition-colors ${consult.status === 'Upcoming'
                                ...
                                {consult.status === 'Upcoming' ? 'Start Call' : 'Open Chat'}
                            </button>
                            <button className="p-2.5 rounded-xl border border-gray-200 text-gray-600 hover:bg-gray-50 transition-colors" title="Mark as Completed">
